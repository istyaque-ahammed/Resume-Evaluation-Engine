...
GOOGLE_CLIENT_ID = "200406322478-2bpcu9nr8dip9hmmdfeep4bfacnmp1ps.apps.googleusercontent.com"
...
app.config['MONGO_URI']= 'mongodb+srv://admin:admin@istyaque.h7j2how.mongodb.net/ResumeEvaluationEngine'
mongo.init_app(app)
